...
<%
	...
	String newLogin = (String) session.getAttribute("newLogin");
	System.out.println("---------------------------------------");
...
<body>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">   
      <a href="./welcome" class="d-flex align-items-center text-dark text-decoration-none">
      ...
      <c:if test="${newLogin eq 'newLogin'}">
      <% System.out.println("if check"); %>
      <script>
	      alert("환영합니다.");
      </script>
      <c:remove var="newLogin" scope="session"/>
      </c:if>    
      <c:if test="${newSignUp eq 'newSignUP'}">
      <% System.out.println("if check2"); %>
      <script>
	      alert("가입을 성공하였습니다.");
      </script>
      <c:remove var="newSignUp" scope="session"/>
      </c:if>   
