...
<script type="text/javascript">
	function checkForm() {
		...
		if (document.newMember.u_pw.value != document.newMember.u_pw_confirm.value) {
 ...
 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
   ...
   <div class="row align-items-md-stretch   text-center">
				...
				if (error != null) {
					...
					out.println("회원가입을 실패했습니다.");
					out.println("</div>");
				}
			%>
		<form name="newMember"  action="signUp_process" method="post" onsubmit="return checkForm()">
			<div class="mb-3 row">
				<label class="col-sm-2 ">아이디</label>
				<div class="col-sm-3">
					<input name="u_id" type="text" class="form-control" placeholder="id" >
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">비밀번호</label>
				<div class="col-sm-3">
					<input name="u_pw" type="text" class="form-control" placeholder="password" >
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">비밀번호확인</label>
				<div class="col-sm-3">
					<input name="u_pw_confirm" type="text" class="form-control" placeholder="password confirm" >
				</div>
			</div>
			<div class="mb-3 row">
