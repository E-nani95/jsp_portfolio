...
<body>
	<div class="container py-4">
		...
		<div class="row align-items-md-stretch">
			<form action="./addBook_process" method="post" enctype="multipart/form-data" class="form-horizontal">
				<div class="mb-3 row">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-5">
						<textarea name="b_exp" cols="50" rows="2"
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-5">
						<input type="file" name="b_img_full" class="form-control">
					</div>
				</div>
				<div class="mb-3 row">
